...
const ERROR_CODE_MAP: Record<InstagramExtractorErrorCode, ExtractionErrorCode> = {
  ...
  fetch_failed: "NETWORK_FAILURE",
  instagram_blocked_request: "BLOCKED",
  parse_failed_no_metadata: "PARSE_FAILED",
  parse_failed_no_profile_image: "PARSE_FAILED",
  parse_failed: "PARSE_FAILED",
  network_timeout: "TIMEOUT",
  rate_limited: "RATE_LIMITED",
  blocked: "BLOCKED",
  cors_error: "NETWORK_FAILURE",
